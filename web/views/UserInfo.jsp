...
<!-- Mirrored from gambolthemes.net/workwise_demo/HTML/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Apr 2019 14:19:13 GMT -->
<head>
<meta charset="UTF-8">
...
<%
    ...
    User user=user_query.searchUserByUserID(userid);
									...
									<div class="user_profile">
										...
										<div class="user_pro_status">
											...
											<ul class="flw-status">
												<li>
													<span>Following</span>
                                                                                                        <b><%=friend_query.countFollowing(userid) %></b>
												</li>
												<li>
													<span>Followers</span>
                                                                                                        <b><%=friend_query.countFollowed(userid) %></b>
												</li>
											</ul>
...
<!-- Mirrored from gambolthemes.net/workwise_demo/HTML/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Apr 2019 14:19:39 GMT -->
</html>