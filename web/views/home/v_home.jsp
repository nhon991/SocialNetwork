                        ...
                        <div class="main-left-sidebar no-margin">
                            <div class="user-data full-width">
                                ...
                                <ul class="user-fw-status">
                                    ...
                                    <li>
                                    <h4>Followed</h4>
                                    <a href="FollowedList"  title="" >  <span><%=friend_query.countFollowed(us.getUser_id())%></span> </a>
                                    </li>
                                    <li>
                                        ...
                                        <div class="post_topbar">
                                            <div class="usy-dt">
                                                ...
                                                <div class="usy-name">
                                                    ...
                                                    <span><img src="public/images/clock.png" alt=""><%=post_query.postTimeAgo(pst.getPost_id()) %></span>
                                                </div>
                                            </div>
                                            <div class="ed-opts">
